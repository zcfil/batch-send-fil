...
export default {
  ...
  methods: {
        ...
        if (valid) {
          ...
          this.$store
            ...
            .then(response => {
              ...
              // this.$store.dispatch('user/download', this.loginForm ).then(() => {   download
              if (response.msg !== 'ok') {
                this.$router.push({ path: '/download' })
              } else {
                this.$router.push({ path: '/loginVerify' })
              }
    ...
    handDownload () {
      this.loading1 = true
      this.$store.dispatch('user/download', this.loginForm).then(() => {
        this.$router.push({ path: '/download' })
        this.loading1 = false
      })
    }
